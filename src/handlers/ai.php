...
- **🔬 研究特化 AI チャット** (#/research-ai) : v1142 で ChatGPT/Claude 風に大改修。 v1255 で 独自 の トークン制 サブスク (tokens_ticket / unlimited_weekly) を 廃止 し、 **AI サブスク (#/ai-sub、 1 週間 500pt) に 統合**。 契約中 は 使い放題、 既存 の 旧サブスク 契約者 は 残 トークン を 使い切れる (grandfather)。 会話 は **スレッド化** (左サイドバー に 履歴)、 他者 と 共有 でき (共有先 も 追加投稿 可)、 画像 / PDF 添付 可 (OpenAI Files API)。 7 テンプレート: テーマ相談 / 実験デザイン / アブスト磨き / 関連研究整理 / リバッタル / 科研費 / 汎用。 v1144: LabPay 内 の AI 結果画面 から 「🔬 この結果 について AI と話す」で 自動的 に 文脈付き スレッド を 作れる
