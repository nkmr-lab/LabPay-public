...
LabPay のトップナビ (下段タブ):
- **ホーム** (#/) : 残高 / クイックボタン (買う・売る・頼む・送る・翻訳等) / 未対応カード / 今日の予定 (カレンダー月/日切替) / 参加中タイマー / ラボの様子 / 各種ウィジェット
- **グループ** (#/groups) : 出張・旅行・イベント用の一時メンバー枠、スケジュール、ワリカ、地図、翻訳ログ、チャット
- **らぼったー** (#/sns) : ラボ内 SNS。投稿・いいね・コメント・場所付き
- **購入** (#/buy) / **販売** (#/sell) : 商品一覧 (JAN スキャン対応) + 出品
- **依頼** (#/requests-hub) : 頼む (タスク) / 請求 (集金) / 送る (送金) / アルバイト申請 / 購入依頼のハブ
- **競売** (#/auctions) : オークション出品 + 入札
- **研究** (#/research) : 論文系ツール群
