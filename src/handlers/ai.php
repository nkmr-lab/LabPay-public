...
- **売買** (#/buy) : 購入商品一覧 (JAN スキャン対応) + 上部から 販売 / オークション / ラーボーイーツ / チケット / 発表順オークション にワンタップ
...
- **📝 原稿チェック** (#/resume-check) : 添削。 v1131 で学生向け先輩トーン + 次の 3 ステップ、 v1141 で 修正 TODO チェックリスト、 v1144 で 🔬 AI と続きチャット
- **🧪 実験計画書チェック** (#/exp-plan) : v1131 で STRICT (査読者ノリ) / STUDENT (先輩トーン) の 2 モード + タブ切替、両モードは 20pt 据え置きで curl_multi 並列実行。 v1141 で 修正 TODO チェックリスト、 v1144 で 🔬 AI と続きチャット
...
- **🔬 研究特化 AI サブスク** (#/research-ai) : v1142 で ChatGPT/Claude 風に大改修。 料金は 件数課金 → **トークン量課金** に変更: 🎟 tokens_ticket_s (200pt / 100k tokens / 30 日) or 🎟 tokens_ticket_l (500pt / 300k tokens / 30 日) or ♾ unlimited_weekly (1000pt / 30 日、 週 500k tokens 上限、自動リセット)。 会話は **スレッド化** (左サイドバーに履歴)、他者と 共有 でき (共有先も追加投稿可、 投稿者のトークンから消費)、 画像 / PDF を添付可能 (OpenAI Files API)。 7 テンプレート: テーマ相談 / 実験デザイン / アブスト磨き / 関連研究整理 / リバッタル / 科研費 / 汎用。 v1144: 上記 5 種の AI 結果画面から「🔬 この結果について AI と話す」で自動的に文脈付きスレッドを作れる
- **📝 研究ノート** (#/research-notes) : Cosense 直結

── 共有タブ (#/shared) ──
- **🗒 Board (ポストイット空間)** (#/board) : v1172 で Miro から Board にリネーム。 グループで自由にポストイット配置、拡大縮小/色/オモテウラ/AI画像生成/ミニマップ/他人カーソル。 部屋は「全員 / グループ / 自分専用」から選べる。 📚 論文 or 🍜 食べある記 から一括貼付、元ページへの 🔗 リンクも保存 (v1171)。 v1173 (計画中): 手書き対応。旧 URL #/miro は #/board にリダイレクト。
- **📋 かんばん** (#/kanban) : Trello 的タスクボード、D&D、担当/期限/コメント
- **💬 チャット** (#/chat-rooms) : 重要 / 連絡 / 相談の 3 チャンネル + DM。 v1140 で デスクトップ (>=900px) では 3 チャンネルを横並び 3 pane で同時表示、 スマホ (<900px) は選択中の 1 pane のみ表示 (タブで切替)。 右上に「✕ ホームへ」常時ボタン
...
── 娯楽タブ (#/games) ──
⚾ ドラフト / 📝 フリップクイズ / 🎮 自作ゲーム (cg2) / 👕 BingoFit / ⚡ 早押しクイズ / 🎨 絵しりとり (5pt/人 固定) / 🎯 ティア表 / 🀄 麻雀 / 🎲 ito (5pt/人 固定) / 🐺 人狼 (5pt/人 固定) / 🔮 占い / 🏆 優勝予想 / 🎯 勝敗予測 / 💣 地雷オセロ / ⭕❌ マルバツ / 🎰 ビンゴ / 🃏 大富豪 (5pt/人 固定) / 🏁 制覇リスト / 🗺 制覇マップ / ✈️ フライト応援 / 🎵 プレイリスト / 🍴 食べある記 / 🎀 プロフ帳 (平成デザ) / 📸 setlog / 🎴 ゼミ人トレカ + ガチャ / 😆 ぼけて (bokete = 画像大喜利、 v1147+)
