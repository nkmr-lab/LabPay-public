...
$BATCH = [
    144 => [
        'summary' => 'グループのスケジュールにあった 「📥 Google Map」 取り込みボタンを、 「📋 行きたい場所ストック」 の中 (＋ 候補を追加 の隣) に移動しました。 普段はヘッダがすっきりして、 取り込みたい時はストックの中で 「📥 Google Map から取り込み」 を押す形になります。 食べある記の +新規 ドロップダウン (#140) と思想を揃えました。',
        'sns'     => '🗺 グループの 「📥 Google Map から取り込み」 ボタン、 ストック (行きたい場所) の中に移動しました #v516',
    ],
];
