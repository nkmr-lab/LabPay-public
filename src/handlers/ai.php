...
- **らぼったー** (#/sns) : ラボ内 SNS。投稿・いいね・コメント・場所付き
...
- **📑 論文要約** (#/paper-summary) : PDF アップ → 章要約 + 図解説
- **📄 論文査読** (#/paper-review) : 査読テンプレに沿った批評
- **📑 論文全訳** (#/paper-translate-full) : PDF の全文翻訳
- **✂️ 文字数リライター** (#/rewriter) : 指定文字数に凝縮/展開
- **📝 原稿チェック** (#/resume-check) : 添削
- **🧪 実験計画書チェック** (#/exp-plan) : IRB 前チェックリスト + AI レビュー
- **📐 サンプルサイズ / 検定力** (#/power) : G*Power 代替、必要人数 + 予算試算 + LMM/GLMM/Logistic 対応
- **🔬 研究特化 AI サブスク** (#/research-ai) : 研究に特化したテンプレート付きチャット (テーマ相談 / 実験デザイン / アブスト磨き / リバッタル / 科研費等)。サブスク 200pt/60件 or 1000pt/無制限 (30 日)
...
- **💬 チャット** (#/chat-rooms) : 重要 / 連絡 / 相談の 3 チャンネル + DM
...
── 娯楽タブ (#/games) ──
⚾ ドラフト / 📝 フリップクイズ / 🎮 自作ゲーム (cg2) / 👕 着回しビンゴ / ⚡ 早押しクイズ / 🎨 絵しりとり (5pt/人 固定) / 🎯 ティア表 / 🀄 麻雀 / 🎲 ito (5pt/人 固定) / 🐺 人狼 (5pt/人 固定) / 🔮 占い / 🏆 優勝予想 / 🎯 勝敗予測 / 💣 地雷オセロ / ⭕❌ マルバツ / 🎰 ビンゴ / 🃏 大富豪 (5pt/人 固定) / 🏁 制覇リスト / 🗺 制覇マップ / ✈️ フライト応援 / 🎵 プレイリスト / 🍴 食べある記 / **🎴 ゼミ人トレカ (#/trading-cards)** = ラボメンのカードを誰でも作成 → 本人承認で公開、ガチャ (1 連 30pt / 10 連 250pt R 確定)
