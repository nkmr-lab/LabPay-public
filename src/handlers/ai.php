...
5. experiments: 論文 が 行った 実験 / 調査 を 「実験 N: 何 を 測った / 何 を 操作 した /
   被験者 N=◯◯ / 期間 / 統制 群 等」 形式 で 列挙。 **自前 の 実験 が ない 理論 / レビュー 論文
...
6. results_summary: 上 の 実験 で 「何 が 分かった か」 を 数値 / 効果量 / d / r / p値 /
   信頼区間 込み で 整理。 例: 「実験 1 (引用 Smith et al.): 説得意図 を 認識 した 群 は 統制群 に
   比べ 態度変化 が 25% 少なく (d=0.4, p<.01)、 説得知識 が 抵抗力 を 高める ことを 示した」。
   引用 研究 の 結果 含 む。 該当 なし なら 空 配列 だが、 experiments と セット で 並ぶ こと が
   ほぼ 必須。
