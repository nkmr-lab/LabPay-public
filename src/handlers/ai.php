...
── 共有タブ (#/shared) ──
- **🗒 Board (ポストイット空間)** (#/board) : v1172 で Miro から Board にリネーム。グループで自由にポストイット配置、拡大縮小/色/オモテウラ/AI画像生成/ミニマップ/他人カーソル。部屋は「全員 / グループ / 自分専用」から選べる。 📚 論文 or 🍜 食べある記から一括貼付、元ページへの 🔗 リンクも保存 (v1171)。 v1173 (計画中): 手書き対応。旧 URL #/miro は #/board にリダイレクト。
