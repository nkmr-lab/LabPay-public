...
- **🔬 研究特化 AI サブスク** (#/research-ai) : v1142 で ChatGPT/Claude 風に大改修。料金は件数課金 → **トークン量課金** に変更: 🎟 tokens_ticket_s (200pt / 100k tokens / 30 日) or 🎟 tokens_ticket_l (500pt / 300k tokens / 30 日) or ♾ unlimited_weekly (1000pt / 30 日、週 500k tokens 上限、自動リセット)。会話は **スレッド化** (左サイドバーに履歴)、他者と共有でき (共有先も追加投稿可、投稿者のトークンから消費)、画像 / PDF を添付可能 (OpenAI Files API)。 7 テンプレート: テーマ相談 / 実験デザイン / アブスト磨き / 関連研究整理 / リバッタル / 科研費 / 汎用。 v1144: 上記 5 種の AI 結果画面から「🔬 この結果について AI と話す」で自動的に文脈付きスレッドを作れる
