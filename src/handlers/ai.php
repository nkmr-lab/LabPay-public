...
── 共有タブ (#/shared) ──
- **🗒 Board (ポストイット空間)** (#/board) : v1172 で Miro から Board にリネーム。グループで自由にポストイット配置、拡大縮小/色/オモテウラ/AI画像生成/ミニマップ/他人カーソル。部屋は「全員 / グループ / 自分専用」から選べる。 📚 論文 or 🍜 食べある記 or 画像/動画から一括貼付、元ページへの 🔗 リンクも保存。 v1173: 手書き対応 (🖱/✏️/🩹 で 選択/手書き/消しゴム 切替 + ペン色/太さ)、 v1182: スマホ 2 本指 pinch 拡大縮小。 v1188: マウス手書きバグ修正 + 作成者/admin 用 ⋯ から「🗑 このボードを削除」。 **v1189: ↗ 矢印モード** (ノート → ノート で 矢印線を接続、 タップで label/色/破線/削除)。 旧 URL #/miro は #/board にリダイレクト。
