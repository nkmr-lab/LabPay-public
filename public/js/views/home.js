...
export const HOME_ACTIONS = [
  ...
  { id: 'room-requests',        url: '#/room-requests',        title: '教室予約依頼',   icon: '🏫', defaultVisible: false },
  { id: 'my-games',             url: '#/my-games',             title: '自作ゲーム管理', icon: '🎮', defaultVisible: false },
  { id: 'quotes',               url: '#/quotes',               title: '名言集',         icon: '💬', defaultVisible: false },
  { id: 'news',                 url: '#/news',                 title: 'IT ニュース', icon: '📰', defaultVisible: false },
...
const SHORTCUT_CARDS_DEFS = [
  ...
  { id: 'sc-room-requests', title: '🏫 教室予約依頼',    url: '#/room-requests', desc: '発表練習など。プロジェクター/大人数/階などの条件で中村さんに教室予約を依頼' },
  ...
  { id: 'sc-news',          title: '📰 IT ニュース', url: '#/news',          desc: '過去30日分のIT記事 (GPT要約付き)' },
...
const NEW_DEFAULT_SHOWN  = ['recruiting', 'entertainment', 'achievements', 'conf-deadlines', 'papers-recent', 'photo-random']; // v641, v649, v651, v671 既存ユーザにも自動表示 / v809 論文新着 widget を既存ユーザにもデフォルト表示 / v1237 photo-random も 既存ユーザに 自動 ON / v1238 nkmr-albums 撤去
...
export async function renderHome() {
  ...
  const cardsToRender = [
    ...
    // v1238 nkmr-albums renderer 撤去 (widget 廃止)
...
// v1238 中村研アルバム widget (Google Photos 列挙) 撤去。 photo-random で 代替。
//   旧 render function は削除、 /api/nkmr-albums + /api/album-thumbs endpoint は
//   admin 側 の DB 管理 UI で 引き続き 使う 可能性 が ある ので サーバ 側 は 残す。
