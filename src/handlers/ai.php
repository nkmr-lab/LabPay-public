...
- figure_refs: その 節 で 言及 する 重要 な 図 / 表 を 厳選 して 入れる (各 節 0-2 件、 全節
  ...
  不確か な とき は "full" に する (= 全 ページ を そのまま 表示)。 「キャプション が 下 だから
  bottom」 等 の 間違い を しない、 図 の 本体 が ある 位置 で 判定 する。 client は この 値 で
  ページ画像 を crop 表示 する ので、 間違える と 「ただの 文章 を crop」 してしまう。
