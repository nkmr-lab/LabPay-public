...
── 共有タブ (#/shared) ──
- **🗒 Miro (ポストイット空間)** (#/miro) : グループで自由にポストイット配置、拡大縮小/色/オモテウラ/AI画像生成/ミニマップ/他人カーソル。部屋は「全員 / グループ / 自分専用」から選べる。 refs から論文を一括貼付 (📚 論文ボタン)
...
- 画像翻訳 (#/translate)
- Miro の画像生成 (ノート内「🖼」→ プロンプト → OpenAI gpt-image-1)
