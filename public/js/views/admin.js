...
async function loadFeedback() {
  ...
  try {
    ...
    if (!d.items.length) { root.innerHTML = '<div class="empty">まだ投稿はありません</div>'; return; }
    root.innerHTML = d.items.map(fbRow).join('');
      ...
      <div style="flex:1; min-width:0">
        ...
        ${replied
          ...
          : `<div style="margin-top:6px">
               <textarea id="fb-reply-${f.id}" rows="2" maxlength="4000" placeholder="例: 対応しました！" style="width:100%; box-sizing:border-box"></textarea>
