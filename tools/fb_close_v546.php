...
$BATCH = [
    205 => [
        'summary' => 'らぼったー の 投稿カード本文 (post body) に overflow-wrap: anywhere + word-break: break-word + min-width: 0 を追加しました。 これで長い URL や 半角の連続文字列が含まれていても 必ずカード幅内で折り返されるので、 横幅が広がる問題は解消するはずです。',
        'sns'     => '🔧 らぼったー: 長い URL で横幅が広がる問題、 投稿本文に overflow-wrap:anywhere 追加で解消 #v546',
    ],
];
