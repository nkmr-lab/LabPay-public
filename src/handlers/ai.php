...
5. experiments: 実験 や 調査 を 行って いる 論文 の 場合 に 限り、 各 実験 を 「実験 N: 何 を
   測った / 何 を 操作 した / 被験者 N=◯◯ / 期間 / 統制 群 等」 形式 で 列挙 (任意、 理論
   論文 等 で 該当 なし なら 空 配列)
6. results_summary: 上 の 実験 で 「何 が 分かった か」 を 数値 / 効果量 / p値 込み で 整理
   (任意、 該当 なし なら 空 配列)
...
- body: 節 本文 の 和訳要約 (**1200-2000 字 以上、 必ず 3-5 段落 に 分けて 構造化**、
