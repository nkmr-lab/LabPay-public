...
route('/room-requests',        lazy(() => import('./views/room_requests.js'), 'renderRoomRequests'));    // v1230 🏫 教室予約依頼 (fb#502)
route('/room-requests/new',    lazy(() => import('./views/room_requests.js'), 'renderRoomRequestNew'));
...
route('/game-missions',         lazy(() => import('./views/game_missions.js'), 'renderGameMissions'));      // v1274 🎯 娯楽ミッション 一覧
route('/game-missions/new',     lazy(() => import('./views/game_missions.js'), 'renderGameMissionNew'));    // v1274 🎯 娯楽ミッション 起票
route('/game-missions/:id',     lazy(() => import('./views/game_missions.js'), 'renderGameMissionDetail')); // v1274 🎯 娯楽ミッション 詳細
route('/manuscript-reviews',        lazy(() => import('./views/manuscript_reviews.js'), 'renderManuscriptReviews'));      // v1282 📝 原稿チェック依頼 一覧
route('/manuscript-reviews/new',    lazy(() => import('./views/manuscript_reviews.js'), 'renderManuscriptReviewNew'));    // v1282 📝 原稿チェック依頼 新規
route('/manuscript-reviews/:id',    lazy(() => import('./views/manuscript_reviews.js'), 'renderManuscriptReviewDetail')); // v1282 📝 原稿チェック依頼 詳細
