...
$BATCH = [
    82 => [
        'summary' => '食べある記 の いいね 数 を 一覧 タイル / ホーム ヒーロー / 地図 ビュー の 一覧 全部 で 0 件 でも 常時 表示 する ように 変更 しました (これ までは 1 件 以上 でしか 出して いません でした)。 「押せる 場所 が ある」 こと を 認識 し やすく なります。',
        'sns'     => '🍴 食べある記 の いいね を 一覧 タイル と ホーム リスト で 0 件 でも 常時 表示 する ように #v487',
    ],
];
