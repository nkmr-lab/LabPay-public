...
$routes = [
    ...
    'room-requests'  => 'route_room_requests',// v1230 教室予約依頼 (fb#502)
    'ai-sub'         => 'route_ai_sub',       // v1251 AI サブスク (chai.nkmr.io / file.nkmr.io 用)
    'game-missions'  => 'route_game_missions', // v1274 娯楽ミッション (主催者 + SYSTEM 50/50 出資)
    'manuscript-reviews' => 'route_manuscript_reviews', // v1282 📝 原稿チェック依頼 (pr.nkmr.io 連携)
    ...
    'quotes'         => 'route_quotes',     // v804 名言 (個人が集める外部の名言)
    'sayings'        => 'route_sayings',    // v1208 ラボメンの年度別 名言/迷言 + 投票
    ...
    'miro'           => 'route_board',        // v1100 Miro 的な共同ポストイット空間 (旧名、alias)
    'board'          => 'route_board',        // v1174 board にリネーム (同じ handler)
